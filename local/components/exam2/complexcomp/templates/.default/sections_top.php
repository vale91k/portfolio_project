...
if ($arParams["SEF_MODE"] == "Y") {
    $sUrl = $arParams["SEF_FOLDER"] . str_replace("#PARAM1#", $param1, $arParams["SEF_URL_TEMPLATES"]["exampage"]) . "?PARAM2=$param2";
} else {
    $sUrl = $APPLICATION->GetCurPage() . "?PARAM1=$param1&PARAM2=$param2";
}
?>
